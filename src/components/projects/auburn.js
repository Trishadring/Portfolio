...
const Aub = () =>  {
  return (
    <div className="container" >
      ...
      <img className="d-block w-100" src="http://tdring.com/w/auburn/imgs/aub1.png" alt="First slide"/>
      <p className="pt-5">
					About Page
				</p>
				<img className="d-block w-100" src="http://tdring.com/w/auburn/imgs/aub2.png" alt="Second slide"/>
				<p className="pt-5">
					Search Results
				</p>
				<img className="d-block w-100" src="http://tdring.com/w/auburn/imgs/aub3.png" alt="Third slide"/>
				<p className="pt-5">
					Check Out Page
				</p>
				<img className="d-block w-100" src="http://tdring.com/w/auburn/imgs/aub4.png" alt="Third slide"/>
				<p className="pt-5">
					Landing Page (After Logged In)
				</p>
				<img className="d-block w-100" src="http://tdring.com/w/auburn/imgs/aub5.png" alt="Third slide"/>
				...
				<img className="d-block w-100" src="http://tdring.com/w/auburn/imgs/gb1.png" alt="First slide"/>
				<p className="pt-5">
					After Logged in
				</p>
				<img className="d-block w-100" src="http://tdring.com/w/auburn/imgs/gb2.png" alt="Second slide"/>
				<p className="pt-5">
					Details Page
				</p>
				<img className="d-block w-100" src="http://tdring.com/w/auburn/imgs/gb3.png" alt="Third slide"/>
